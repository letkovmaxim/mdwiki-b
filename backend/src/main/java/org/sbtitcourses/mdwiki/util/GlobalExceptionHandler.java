...
public class GlobalExceptionHandler {
    ...
    /**
     * Метод, отвечающий за обработку исключений типа NotFound
     * @param e объект исключения
     * @return DTO сообщения об ошибке с кодом 404
     */
    @ExceptionHandler({PersonNotFoundException.class, SpaceNotFoundException.class,
    ...
    private ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException e) {
        ...
        ErrorResponse response = new ErrorResponse(errors, new Date());
